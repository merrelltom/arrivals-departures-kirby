...
curl_setopt_array($curl, [
    ...
    CURLOPT_URL => 'http://localhost:44444/departures/story_mod',
    CURLOPT_ENCODING => "",
...
foreach ($results as $result) { ?>
    <form method="post" action="./story-moderation" class="row moderation-row <?php if( strlen($result["story"]) == 0){ echo 'visuallyhidden';}?>" id="d-board-line-<?php echo($board_line);?>">
        ...
        <div class="radio-wrapper col-xs-12 col-md-2">
            <div>
                <input type="radio" id="accept-d-<?php echo($board_line);?>" name="update" value="accept">
                <label for="accept-d-<?php echo($board_line);?>"><span class="label">Accept</span></label>
            </div>
        </div>
