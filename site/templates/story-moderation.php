...
<main class="main"> 
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    if ($update_type == 'arrival'){
                        snippet('arrivals-update-story', ['token'=>$token, 'action'=>$action, 'ID'=>$id]);
                    } elseif ($update_type == 'departure'){
                        snippet('departures-update-story', ['token'=>$token, 'action'=>$action, 'ID'=>$id]);
                    } ?>
                </div>
            </div>
        </div>
    ...
    <section class="page-section moderation-forms arrival-moderation">
        <div class="wrapper">
            <?php snippet('arrivals-moderate-story', ['token'=>$token]) ?>
        </div>
    </section>

    <section class="page-section moderation-forms arrival-moderation">
        <div class="wrapper">
            <?php snippet('departures-moderate-story', ['token'=>$token]) ?> 
        </div>
    </section>
